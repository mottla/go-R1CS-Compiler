...
func TestBnPool_Count(t *testing.T) {
	...
	a37 := g1.ScalarBaseMult(bigFromBase10("37"))
	pair1 := Pair(a37, g2)
	fmt.Println(pair1)

	pair2 := Pair(g1clone, g2clone)
	fmt.Println(pair2.ScalarMult(pair2, bigFromBase10("37")))

	//new(GT).ScalarMult()
	//
	//for i := int64(0); i < 10; i++ {
	//	fmt.Println(g1.Marshal())
	//	g1.ScalarBaseMult(new(big.Int).SetInt64(i))
	//}
